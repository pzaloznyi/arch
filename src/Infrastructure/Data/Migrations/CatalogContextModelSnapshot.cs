...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineShop.ApplicationCore.Entities.Basket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("OnlineShop.ApplicationCore.Entities.BasketItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("OnlineShop.ApplicationCore.Entities.CatalogBrand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("OnlineShop.ApplicationCore.Entities.CatalogItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("OnlineShop.ApplicationCore.Entities.CatalogType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("OnlineShop.ApplicationCore.Entities.BasketItem", b =>
                {
                    b.HasOne("OnlineShop.ApplicationCore.Entities.Basket")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("OnlineShop.ApplicationCore.Entities.CatalogItem", b =>
                {
                    b.HasOne("OnlineShop.ApplicationCore.Entities.CatalogBrand", "CatalogBrand")
                        .WithMany()
                        .HasForeignKey("CatalogBrandId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("OnlineShop.ApplicationCore.Entities.CatalogType", "CatalogType")
                        .WithMany()
